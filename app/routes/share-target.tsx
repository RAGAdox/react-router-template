...
export async function loader({
  ...
  try {
    ...
    if (validationResult.isValid) {
      ...
      const response = await (await fetch(functionUrl)).json();
      return { spotifyTrackDetails: response, error: false };
    }
    throw new Error("Invalid Spotify URL or Unable to get data");
  } catch (error) {
